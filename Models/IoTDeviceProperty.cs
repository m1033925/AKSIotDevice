...
namespace IOTDeviceApp.Models
{
    public class IoTDeviceProperty : IDeviceProperties
    {
        ...
        static readonly string iotDevUpdatConnString = Constant.IOTDevUpdatConnString.ToString();
        ...
        public  async Task UpdateDesiredProperties(string deviceName)
        {
            ...
            registryManager = RegistryManager.CreateFromConnectionString(iotDevUpdatConnString);
